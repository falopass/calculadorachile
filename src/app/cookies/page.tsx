    ...
    <>
      ...
      >
        ...
        <p>
          ...
          preferencias, analizar el uso del sitio y mostrar contenido
          personalizado.
        </p>
        ...
        <ul>
          <li>
            <strong>theme:</strong> Guarda tu preferencia de tema (claro/oscuro).
        ...
        <ul>
          <li>
            <strong>Google Analytics (_ga, _gid, _gat):</strong> Analizan el
            tráfico del sitio y generan estadísticas de uso.{' '}
            <a
        ...
        <ul>
          <li>
            <strong>Google AdSense (NID, IDE, etc.):</strong> Muestran anuncios
        ...
        <p>
          <strong>Nota:</strong> Desactivar cookies puede afectar la
          funcionalidad del sitio.
        </p>

        <h2>4. Cookies de Terceros</h2>
        <p>
          Algunas cookies son colocadas por servicios de terceros. No tenemos
          control sobre estas cookies. Te recomendamos revisar las políticas de
        ...
        <p>
          Al usar CalculaChile, consientes el uso de cookies según lo descrito en
          esta política. Puedes retirar tu consentimiento en cualquier momento
          modificando la configuración de cookies en tu navegador.
        </p>

        <h2>6. Actualizaciones</h2>
        <p>
          Esta política puede actualizarse cuando agreguemos o modifiquemos los
          servicios que utilizamos. Te notificaremos cambios significativos a
          través de un aviso en el sitio.
        </p>

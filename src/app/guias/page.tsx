...
const categories: GuideCategory[] = [
  {
    ...
    guides: [
      ...
      },
      {
        ...
        calculatorHref: '/calculadoras/finiquito',
      },
      {
        ...
        calculatorHref: '/calculadoras/horas-extra',
      },
      {
        ...
        calculatorHref: '/calculadoras/vacaciones',
      },
    ],
  },
  {
    ...
    guides: [
      {
        ...
        calculatorHref: '/calculadoras/iva',
      },
      {
        ...
        calculatorHref: '/calculadoras/boleta-honorarios',
      },
      {
        ...
        calculatorHref: '/calculadoras/operacion-renta',
      },
    ],
  },
  {
    ...
    guides: [
      {
        ...
        calculatorHref: '/calculadoras/credito-hipotecario',
      },
      {
        ...
        calculatorHref: '/calculadoras/reajuste-arriendo',
      },
      {
        ...
        calculatorHref: '/calculadoras/uf-clp',
      },
    ],
  },
  {
    ...
    guides: [
      {
        ...
        calculatorHref: '/calculadoras/permiso-circulacion',
      },
      {
        ...
        calculatorHref: '/calculadoras/multas-transito',
      },
      {
        ...
        calculatorHref: '/calculadoras/costo-tag',
      },
    ],
  },
];

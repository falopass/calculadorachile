      ...
      <div className="relative z-10 flex flex-col items-start justify-center min-h-screen px-4 sm:px-6 md:px-16 py-16 md:py-20">
        <div className="w-full">
          ...
          <h1 className="mb-4 md:mb-6 overflow-hidden">
            <span
              className="block text-white font-heading tracking-tight text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.1]"
            >
              Calculadoras
            </span>
            <span
              ref={chileRef}
              className="block text-transparent bg-clip-text bg-gradient-to-r from-[#60A5FA] to-[#DC2626] font-drama italic text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-[10rem] leading-none mt-1"
            >
              Chile.
            </span>
          </h1>
